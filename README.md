...
- `dist\DNA_Retrieval_Engine.exe`：单文件版本，SHA-256 `BEF50573798A64870316C46883F273D4A249F55359C6CA5187429D487F2E732C`
- `dist\DNA_Retrieval_Engine_onedir\DNA_Retrieval_Engine_onedir.exe`：目录版本，SHA-256 `EAA5BBDC3A6C433C9755B79121DDF9D89550343DB43EAC50D0AB8DD91A47051F`
...
根因、修复和实测数据见 [前端卡死与内存增长调研报告](docs/stability-investigation.md)。通用开发方法论同时写入 `D:\pywebview前端稳定性与防卡死方法论.md`。
